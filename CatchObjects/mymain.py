...
while running:
    ...
    pink_count = small_font.render(f"Pinks: {pink}", True, PINK)
    missed_text = small_font.render(f"Missed: {missed}/10", True, RED)
    screen.blit(score_text, (10, 10))
    screen.blit(pink_count, (10, 50))
    ...
    if game_over:
        ...
        pink_count = small_font.render(f"Pinks found: {pink}", True, PINK)
        restart_text = small_font.render("Press R to Restart", True, WHITE)
        
        screen.blit(game_over_text, (WIDTH // 2 - 150, HEIGHT // 2 - 50))
        screen.blit(final_score, (WIDTH // 2 - 120, HEIGHT // 2 + 10))
        screen.blit(pink_count, (WIDTH // 2 - 120, HEIGHT // 2 + 10))
